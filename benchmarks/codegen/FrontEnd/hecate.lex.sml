functor HecateLexFun(structure Tokens: Hecate_TOKENS)  = struct
...
fun yyAction2 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm; (Tokens.TRAVERSAL(yypos, yypos + size yytext))
      end
fun yyAction3 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.CASE(yypos, yypos + size yytext))
      end
fun yyAction4 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.RECUR(yypos, yypos + size yytext))
      end
fun yyAction5 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.ITERATE(yypos, yypos + size yytext))
      end
fun yyAction6 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.LEFT(yypos, yypos + size yytext))
      end
fun yyAction7 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.RIGHT(yypos, yypos + size yytext))
      end
fun yyAction8 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.EVAL(yypos, yypos + size yytext))
      end
fun yyAction9 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.INTERFACE(yypos, yypos + size yytext))
      end
fun yyAction10 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.INPUT(yypos, yypos + size yytext))
      end
fun yyAction11 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.OUTPUT(yypos, yypos + size yytext))
      end
...
fun yyAction13 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.TBOOL(yypos, yypos + size yytext))
      end
fun yyAction14 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.TSET(yypos, yypos + size yytext))
      end
fun yyAction15 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.CLASS(yypos, yypos + size yytext))
      end
fun yyAction16 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.CHILDREN(yypos, yypos + size yytext))
      end
fun yyAction17 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.RULES(yypos, yypos + size yytext))
      end
fun yyAction18 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.SELF(yypos, yypos + size yytext))
      end
...
fun yyAction26 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.NOT(yypos, yypos + size yytext))
      end
...
fun yyAction37 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.HOLE(yypos, yypos + size yytext))
      end
...
fun yyAction47 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.BOOL(true, yypos, yypos + size yytext))
      end
fun yyAction48 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.BOOL(false, yypos, yypos + size yytext))
      end
fun yyAction49 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.NULL(yypos, yypos + size yytext))
      end
...
fun yyQ39 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"|"
              then yyQ41(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ53(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ52(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ55(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ54(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then if inp = #"h"
                  then yyQ43(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ59(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ58(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"l"
                  then yyQ57(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ56(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ65(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ63(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ68(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ67(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ66(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"g"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ69(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"f"
                  ...
                  then if inp = #"e"
                      then yyQ60(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                      else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp = #"i"
                  then yyQ61(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"v"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"v"
              then if inp = #"u"
                  then yyQ62(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ74(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"p"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ73(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ72(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction49(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ77(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ82(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ90(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ89(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ88(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ87(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ96(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ95(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"p"
                  then yyQ91(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"g"
                  ...
                  then if inp = #"f"
                      then yyQ83(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                      else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp = #"n"
                  then yyQ84(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"u"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"t"
                  then yyQ85(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction48(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ42(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ106(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"v"
              then if inp = #"l"
                  then yyQ105(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ116(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ114(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ120(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ119(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ118(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ124(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ123(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
...
fun yyQ28 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"a"
              then yyQ111(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"a"
              then if inp = #"A"
                  then yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp < #"A"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ127(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ126(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ125(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"?"
              then yyQ128(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction31(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ129(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction29(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ131(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
...
fun yyQ133 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction50(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ133(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction36(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ134(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
...
fun yyQ8 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"&"
              then yyQ135(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ136(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ137(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
